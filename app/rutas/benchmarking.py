...
@benchmarking_bp.route('/benchmarking/grupos', methods=['POST'])
def crear_grupo_benchmarking():
    ...
    try:
        ...
        if not nombre_grupo:
            return jsonify({
                'success': False,
                'error': 'Nombre del grupo requerido'
            }), 400
...
@benchmarking_bp.route('/benchmarking/grupos/<int:benchmarking_id>', methods=['GET'])
...
@benchmarking_bp.route('/benchmarking/grupos/<int:benchmarking_id>/usuarios', methods=['POST'])
def agregar_usuario_a_grupo(benchmarking_id):
    ...
    try:
        ...
        success = Usuario_Benchmarking.agregar_usuario_a_grupo(usuario_id, benchmarking_id)
...
@benchmarking_bp.route('/benchmarking/grupos/<int:benchmarking_id>/usuarios/<int:usuario_id>', methods=['DELETE'])
def remover_usuario_de_grupo(benchmarking_id, usuario_id):
    """Remover un usuario de un grupo de benchmarking"""
    try:
        success = Usuario_Benchmarking.remover_usuario_de_grupo(usuario_id, benchmarking_id)
        ...
        return jsonify({
            'success': False,
            'error': 'Error removiendo usuario del grupo'
        }), 500
    except Exception as e:
        return jsonify({
            'success': False,
...
@benchmarking_bp.route('/usuarios/<int:usuario_id>/benchmarking/grupos', methods=['GET'])
...
@benchmarking_bp.route('/benchmarking/comparar', methods=['GET'])
def comparar_con_grupo():
    ...
    try:
        ...
        if not usuario_id or not indicador:
            return jsonify({
                'success': False,
                'error': 'Usuario ID e indicador requeridos'
            }), 400
...
@benchmarking_bp.route('/benchmarking/grupos/<int:benchmarking_id>/estadisticas', methods=['GET'])
...
@benchmarking_bp.route('/ranking/<sector>', methods=['GET'])
...
@benchmarking_bp.route('/ranking/<sector>/exportar/sheets', methods=['POST'])
def exportar_ranking_sheets(sector):
    ...
    try:
        ...
        return jsonify({
            'success': False,
            'error': 'Error exportando ranking a Google Sheets'
        }), 500
    except Exception as e:
        return jsonify({
            'success': False,
...
@benchmarking_bp.route('/ranking/<sector>/exportar/excel', methods=['GET'])
def exportar_ranking_excel(sector):
    ...
    try:
        ...
        return jsonify({
            'success': False,
            'error': 'Error exportando ranking a Excel'
        }), 500
    except Exception as e:
        return jsonify({
            'success': False,
...
@benchmarking_bp.route('/benchmarking/grupos/<int:benchmarking_id>/exportar/sheets', methods=['POST'])
def exportar_benchmarking_sheets(benchmarking_id):
    ...
    try:
        ...
        exporter = GoogleSheetsExporter()
        success = exporter.exportar_benchmarking_grupo(benchmarking_id, indicador, spreadsheet_id)
        ...
        return jsonify({
            'success': False,
            'error': 'Error exportando benchmarking a Google Sheets'
        }), 500
    except Exception as e:
        return jsonify({
            'success': False,
